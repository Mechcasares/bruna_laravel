...
<main class = "principalcarrito">
    <section class="seccion1carrito row">
      <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
        ...
        <div class="card-body">
          <p class="card-text titulocarrito font-weight-bold">ANDERSON</p>
      ...
      <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
          ...
          <div class="card-body">
            <p class="card-text titulo font-weight-bold">TIA</p>
        ...
        <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
            ...
            <div class="card-body">
              <p class="card-text titulocarrito font-weight-bold">TYRELL</p>
          ...
          <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
              ...
              <div class="card-body">
                <p class="card-text titulo font-weight-bold">ANDERS</p>
            ...
            <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
                ...
                <div class="card-body">
                  <p class="card-text titulocarrito font-weight-bold">KARI</p>
              ...
              <div class="card articulo1carrito" style="width: 18rem; height: 24rem">
                  ...
                  <div class="card-body">
                    <p class="card-text titulocarrito font-weight-bold ">ROSCOE</p>
